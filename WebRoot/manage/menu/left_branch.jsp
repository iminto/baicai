...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body re="${path }/mgr_branch/branchList.dql"> <!-- 在这里设置re属性是指定默认打开页面 -->
        <div class="leftMenu_main">
            ...
            <div class="viewport">
                <div class="overview">
                    <a href="javascript:void(0);" class="nav_header sel">分公司管理</a>
                    <ul class="nav_list">
                        <li class="sel"><a href="${path }/mgr_branch/branchList.dql" target="mainFrame">分公司列表</a></li>
                    </ul>
